    ...
    <section className={className}>
      ...
      <div className="container-lux relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          <Link href="/collections?sort=new-arrivals" className="group block relative aspect-[4/3] md:aspect-[16/9] lg:aspect-[2/1] rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-black/50">
            <Image
          ...
          <Link href="/collections?sort=best-sellers" className="group block relative aspect-[4/3] md:aspect-[16/9] lg:aspect-[2/1] rounded-2xl overflow-hidden shadow-2xl border border-white/10 bg-black/50">
            <Image
