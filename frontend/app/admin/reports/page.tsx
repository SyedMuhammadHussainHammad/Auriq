...
export default function ReportsPage() {
  return (
    <div className="flex flex-col items-center justify-center h-[70vh] text-center max-w-lg mx-auto">
      ...
      <h1 className="text-3xl font-serif font-bold text-foreground mb-4">Advanced Analytics</h1>
      <p className="text-foreground/60 leading-relaxed">
        View deep insights into top-selling perfumes, revenue by category, customer retention, and conversion rates. This module is pending backend integration.
      </p>
    </div>
  );
}
